...
export function drawLogin() {
    ...
    content.insertAdjacentHTML('afterbegin', `<h2 class="topper">
            Login
          </h2>
          ...
          <fieldset class="login-details form">
            <div class="form__field">
              ...
              <input id="login" type="text" class="form__input" placeholder="Enter your login">
              <p class="validation-error"></p>
            </div>
            <div class="form__field">
              <label for="pass" class="form__label"><span>*</span>Your Password</label>
              <input id="pass" type="password" class="form__input" placeholder="Enter your password">
              <p class="validation-error"></p>
            </div>
