...
export function drawAnimalInfo(animal) {
    if (!animal)
        return;
    const section = document.querySelector('.animal-about');
    ...
    const descriptionTitles = ['Common name', 'Scientific name', 'Type', 'Size', 'Diet', 'Habitat', 'Range'];
    descriptionTitles.forEach((title) => {
    ...
    section === null || section === void 0 ? void 0 : section.append(animalInfo);
}
